...
<link href="/mdi1/mdi1/css/user_admin.css" rel="stylesheet">
                    ...
                    <div class="module3_ForMainTitle" >
                                        ...
                                        <div class="Module_Layout_1_1_1_1_0" style="margin-left:10px; margin-top:6px; margin-right: 6px; width:38px !important;">
                                            ...
                                            <div class="page2view_id_body_title_part1_ForMainTitle_Total">
                                                    ...
                                                    <a class = "Module_Layout_1_1_1_1_1_0" STYLE="MARGIN-RIGHT:12PX; font-size:22px; color: #6f6f6f !important;">출시 연도</a>
                                                    <a class = "Module_Layout_1_1_1_1_1_0_22" STYLE="MARGIN-RIGHT:12PX; font-size:22px;">></a>
                                                    <a class = "Module_Layout_1_1_1_1_1_0" STYLE="MARGIN-RIGHT:12PX; font-size:22px; color: #6f6f6f !important;">제조사</a>
                                                    <a class = "Module_Layout_1_1_1_1_1_0_22" STYLE="MARGIN-RIGHT:12PX; font-size:22px;">></a>
                                                    <a class = "Module_Layout_1_1_1_1_1_0" STYLE="MARGIN-RIGHT:12PX; font-size:22px; color: #6f6f6f !important;">디바이스 명칭</a>
                                            </div>
                                        ...
                                        <div class="page2view_id_body_title_ForMainTitle" >
                                            ...
                                            <div class="page2view_id_body_title_part2_ForMainTitle">
                                                <div class="page2view_id_body_title_part2_name_device_ForMainTitle">
                                                <a style="color:rgb(255, 0, 170) !important;">새로운 디바이스 추가하기</a>
                                                </div>
                                            </div>
...
<div class="page2view_id_body_content_outer_title_moduleName3_admin">
    <button type="save_button" class="save_button_admin_page2" onclick="check_input_create2()">
        <a>완료</a>
    </button>
</div>
...
<form name="member" action="./insert_create2.php" method="post">
                ...
                <div class="chart_div">
                        ...
                        <div class="chart_div_image3_modify_ProductDevice" style="width:300px; justify-content:left;">
                            <div class="modify_box" style="width: 100%;">
                                <input class = "modify_input_box" type="text" name="name_device_post" placeholder="name_device">
                            </div>
                        </div>
                        ...
                        <div class="chart_div_graph_device_nochart_ProductDevice" style="width: 225px";>
                            ...
                            <div class="chart_div_core_modify">
                                <div class="modify_guide_div_cpu" >
                                    ...
                                    <a class="modify_guide_a3" style="margin-left:63px; font-size:14px; color:white !important;">텍스트</a>
                                </div>
                            </div>
                ...
                <div class="chart_div">
                        ...
                        <div class="chart_div_image3_modify" style="width:135px; justify-content:left;">
                            <div class="modify_box">
                                <input class = "modify_input_box" type="text" name="manf_device_post" placeholder="manf_device">
                            </div>
                        </div>
                        ...
                        <div class="chart_div_graph_device_nochart" style="width: 390px;">
                            ...
                            <div class="chart_div_core_modify">
                                <div class="modify_guide_div_cpu">
                                    ...
                                    <a class="modify_guide_a3" style="margin-left:214px; font-size:14px;">텍스트</a>
                                </div>
                            </div>
            ...
            <div class="line_spec">   
                <div class="chart_div">
                        ...
                        <div class="chart_div_image3_modify" style="width: 190px; justify-content:left;">
                            <div class="modify_box">
                            <input class = "modify_input_box" type="text" name="cpu_device_post" placeholder="cpu_device">
                            </div>
                        </div>
                        ...
                        <div class="chart_div_graph_device_nochart" style="width:335px; justify-content:left;">
                            ...
                            <div class="chart_div_core_modify">
                                <div class="modify_guide_div_cpu">
                                    ...
                                    <a class="modify_guide_a1">를 입력하세요.</a>
                                    <a class="modify_guide_a3" style="margin-left:100px; font-size:14px;">텍스트</a>
                                </div>
                            </div>
        ...
        <div class="module_spec_device_version2_modify">
            <div class="line_spec">   
                <div class="chart_div">
                        ...
                        <div class="chart_div_image3_modify" style="width:110px; justify-content:left;">
                            <div class="modify_box">
                            <input class = "modify_input_box" type="text" name="type_device_post" placeholder="type_device">
                            </div>
                        </div>


                    
                        <div class="chart_div_graph_device_nochart" style="width: 415px;">

                            <div class="chart_div_core_modify">
                                <div class="modify_guide_div_cpu">
                                    <a class="modify_guide_a2">기기 유형</a>
                                    <a class="modify_guide_a1">을 입력하세요.</a>
                                    <a class="modify_guide_a3" style="margin-left:100px;">laptop</a>
        ...
        <div class="module_spec_device_version2_modify">
            <div class="line_spec">   
                <div class="chart_div">
                        ...
                        <div class="chart_div_image3_modify" style="width:136px;">
                            <div class="modify_box">
                                <input class = "modify_input_box" type="text" name="release_device_post" placeholder="release_device">
                            </div>
                        </div>
                        ...
                        <div class="chart_div_graph_device_nochart_admin" style="width:340px !important;">

                            <div class="chart_div_core_modify" >
                                <div class="modify_guide_div_cpu">
                                    <a class="modify_guide_a2">출시 연도</a><a class="modify_guide_a1">를 입력하세요.</a>
                                    <a class="modify_guide_a3" style="margin-left :80px;">단위 :</a>
        ...
        <div class="module_spec_device_version2_modify">
            <div class="line_spec">   
                <div class="chart_div">
                        ...
                        <div class="chart_div_image3_modify" style="width:145px;">
                            <div class="modify_box">
                            <input class = "modify_input_box" type="text" name="diagonal_device_post" placeholder="diagonal_device">
                            </div>
                        </div>
                        ...
                        <div class="chart_div_graph_device_nochart_admin" style="width:331px !important;">
      
                            <div class="chart_div_core_modify">
                                <div class="modify_guide_div_cpu">
                                    <a class="modify_guide_a2">디스플레이 크기</a><a class="modify_guide_a1">를 입력하세요.</a>
        ...
        <div class="module_spec_device_version2_modify">
            <div class="line_spec">   
                <div class="chart_div">
                        ...
                        <div class="chart_div_image3_modify" style="width:128px;">
                            <div class="modify_box">
                            <input class = "modify_input_box" type="text" name="weight_device_post" placeholder="weight_device">
                            </div>
                        </div>
                        ...
                        <div class="chart_div_graph_device_nochart_admin" style="width:348px !important;">
 
                            <div class="chart_div_core_modify" >
                                <div class="modify_guide_div_cpu">
                                    <a class="modify_guide_a2">무게</a><a class="modify_guide_a1">를 입력하세요.</a>
                                    <a class="modify_guide_a3" style="margin-left:160px;">단위 :</a>
